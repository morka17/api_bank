...
// Source: github.com/morka17/shiny_bank/v1/src/db/sqlc (interfaces: Store)
...
// GetTranser mocks base method.
func (m *MockStore) GetTranser(arg0 context.Context, arg1 int64) (db.Transfer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetTranser", arg0, arg1)
	ret0, _ := ret[0].(db.Transfer)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetTranser indicates an expected call of GetTranser.
func (mr *MockStoreMockRecorder) GetTranser(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetTranser", reflect.TypeOf((*MockStore)(nil).GetTranser), arg0, arg1)
}
...
// RemoveAccountBalance mocks base method.
func (m *MockStore) RemoveAccountBalance(arg0 context.Context, arg1 db.RemoveAccountBalanceParams) (db.Account, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RemoveAccountBalance", arg0, arg1)
	ret0, _ := ret[0].(db.Account)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// RemoveAccountBalance indicates an expected call of RemoveAccountBalance.
func (mr *MockStoreMockRecorder) RemoveAccountBalance(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RemoveAccountBalance", reflect.TypeOf((*MockStore)(nil).RemoveAccountBalance), arg0, arg1)
}
